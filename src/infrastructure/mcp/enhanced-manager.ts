/**
 * VIBE-CLI v0.1.0 - Enhanced MCP Manager
 * Advanced Model Context Protocol management with multi-modal support, health checks, and resilience.
 */
    ...
    private async connectToServer(name: string, config: MCP_SERVER_CONFIG, attempt: number = 1): Promise<void> {
        ...
        try {
            ...
            const client = new Client(
                { name: "vibe-ai-teammate", version: "0.1.0" },
                {
                    capabilities: {
                        experimental: {
                            imageContext: {},
