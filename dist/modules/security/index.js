...
export class SecurityModule extends BaseModule {
     ...
     */
    async auditDependencies(params, startTime) {
     ...
     */
    async autoFix(params, startTime) {
...
Return ONLY the fixed code, no explanations.`;
     ...
     */
    async generateReport(params, startTime) {
...
5. Remediation Steps`;
     ...
     */
    getFixForVulnerability(vulnerability) {
        for (const pattern of this.securityPatterns) {
